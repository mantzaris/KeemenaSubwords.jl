...
Use models that are redistributable and already in your built-ins/artifacts:
...
- `TokenizationResult`
  ...
  - `offsets::Union{Nothing, Vector{Tuple{Int,Int}}}` (char offsets)
...
- ByteLevel segments (best-effort)
